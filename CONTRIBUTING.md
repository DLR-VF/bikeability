# Bikeability Contributing Guidelines

Thanks for using `bikeability` and considering contributing code, reporting bugs, fixing bugs or discussing the future of this project. 
